...
profvis({
  ...
  library(rpart)
  library(rpart.plot)
  heart_tree <-rpart(target ~., data = heart_train, method="anova")
  summary(heart_tree)
  ...
  #.....Developed function to calculate RMSE........................
  ...
  print(compare_performance(heart.binary.glm,glm_heart,heart_gam,heart_tree))
})
