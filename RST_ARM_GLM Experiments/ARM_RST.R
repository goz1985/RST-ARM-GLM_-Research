...
write.csv(Kariki_Reduct2,"D:\\Phd Research\\Experiment_2\\kariki_2_GH.csv", row.names = FALSE)
...
kariki_rules <- apriori(kariki_trans_GH,parameter = list(minlen = 2,supp= 0.01, conf = 0.8, maxlen=3),appearance = list(rhs= c("Rain=Yes", "Rain=No")))
...
print(compare_performance(kariki_binary_model1,kariki_ML))
